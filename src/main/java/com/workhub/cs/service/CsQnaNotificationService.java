...
public class CsQnaNotificationService {
     ...
     */
    public void notifyCsQnaCreated(Long projectId, Long csPostId, Long csQnaId,
        ...
        notificationPublisher.publishCsQna(receivers, NotificationType.CS_QNA_COMMENT_CREATED,
